...
def main():
    ...
    html_file_folder = """/Users/rohith/Documents/DSGA1006/MarkupLM"""
    # with open(
    #     "/Users/rohith/Documents/DSGA1006/contract_labeling_with_TOC/contract_name_map.json",
    #     "r",
    # ) as data:
    #     contract_map = json.load(data)

    html_files = [x for x in os.listdir(html_file_folder) if (x.endswith(".html") or x.endswith(".htm"))]
    data = {}
    print(html_files)
