...
def prepare_results_dir(pipeline_config, match_metadata_df, contract_uid):
...
def viz_results_single_contract(pipeline_config, match_metadata_df, contract_uid):
    """Main Execution
    ...
    (
        ...
        input_pdf_dst_path,
        input_html_dst_path,
    ) = prepare_results_dir(pipeline_config, match_metadata_df, contract_uid)
    ...
    contract_tracker = annotate_images(
        match_metadata_df,
        full_contract_image_dir,
        annotated_image_dir,
        contract_tracker,
